...
const ProfileScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <StatusBar barStyle="light-content" backgroundColor="#1C1C1E" translucent={Platform.OS === 'android'} />
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.profileSection}>
          ...
          <Text style={styles.userRole}>Group Fitness Instructor / personal Trainer at Fitness Life</Text>
          ...
          <View style={styles.statsContainer}>
            ...
            <View style={styles.statCard}>
              <View style={[styles.statIconContainer, {backgroundColor: '#FF6B00'}]}>
          ...
          <View style={styles.menuContainer}>
            <TouchableOpacity style={styles.menuItem}>
              ...
              <Feather name="chevron-right" size={20} color="#8E8E93" style={styles.menuArrow} />
            </TouchableOpacity>
